...
bool Json::isCorrectFormat()
{
    return d->isCorrectJsonFormat;
}
...
QString Json::toString(QJsonDocument::JsonFormat format) const {
    return QString::fromUtf8(QJsonDocument(d->root).toJson(format));
}
